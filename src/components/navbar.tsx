    ...
    <header
      className={cn(
        ...
        transparent
          ...
          : "bg-white/90 border-b border-border backdrop-blur-xl shadow-sm",
      )}
    >
      <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        <button
          ...
          className={cn(
            ...
            transparent ? "text-white hover:bg-white/10" : "text-gray-600 hover:bg-surface-alt",
          )}
      ...
      {open && (
        <div className={cn(
          "px-4 pb-4 md:hidden",
          transparent ? "bg-gray-900/95 backdrop-blur-xl" : "border-t border-border bg-white",
        )}>
