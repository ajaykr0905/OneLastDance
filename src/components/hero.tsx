...
const heroImages = [
  {
    src: "https://images.unsplash.com/photo-1561731216-c3a4d99437d5?w=1920&q=80",
    alt: "Bengal Tiger in Indian wilderness",
  },
  {
    src: "https://images.unsplash.com/photo-1549480017-d76466a4b7e8?w=1920&q=80",
    alt: "Majestic tiger walking through forest",
  },
  {
          ...
          <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
            ...
            >
              ...
              <p className="mt-6 max-w-xl text-lg leading-relaxed text-gray-300">
                A centralized platform connecting wildlife sanctuaries, conservation
                scientists, and environmental resources across India.
              </p>
      ...
      <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
        ...
        >
          ...
          <p className="mx-auto mt-3 max-w-xl text-gray-600">
            Everything you need to explore and support wildlife conservation in India.
          </p>
        </motion.div>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {features.map((feature, i) => (
            ...
            >
              <Link
                href={feature.href}
                className="group relative block overflow-hidden rounded-2xl border border-border bg-white shadow-sm transition-all hover:shadow-xl hover:-translate-y-1"
              >
